/**
 * MyDeleteBorrowerInformationPanel
 */
...
public class MyDeleteBorrowerInformationPanel extends JPanel {
	public MyDeleteBorrowerInformationPanel(LibrarySystem ourLib) {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (input.getText().equals("")) {
					...
					ourLib.deleteOneBorrower(input.getText(), result_label);
					ourLib.saveFile();
				}
			}
		});
