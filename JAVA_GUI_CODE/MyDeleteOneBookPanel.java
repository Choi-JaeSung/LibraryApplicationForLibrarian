...
public class MyDeleteOneBookPanel extends JPanel {
	public MyDeleteOneBookPanel(LibrarySystem ourLib) {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (input.getText().equals("")) {
					...
					try{
					ourLib.deleteOneBook(Integer.parseInt(input.getText()), result_label);
					ourLib.saveFile();
					}catch(Exception ex){
